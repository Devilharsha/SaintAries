...
from aries import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
...
from aries import telethn  TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "<code> Connecting to Nakiri Ayame  </code>", parse_mode=ParseMode.HTML)

    text = (f"╒═══「<b> Nakiri Ayame DB Userinfo:</b> 」\n"
