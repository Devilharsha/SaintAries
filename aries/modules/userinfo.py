...
from aries.modules.sql.afk_sql import is_afk, set_afk
...
from aries import SUPPORT_CHAT

SHU = "https://telegra.ph/file/8a981d6fb22c48333af3a.jpg"
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Updates", url="https://t.me/Thanmaibots"),
                            InlineKeyboardButton(
                                "support", url="https://t.me/thanmaisupport")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Edward elric Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By lonelykingstar」</b>"
    update.effective_message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Support", url=f"https://t.me/thanmaisupport"),
                            InlineKeyboardButton(
                                "Updates", url=f"https://t.me/Thanmaibots")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
